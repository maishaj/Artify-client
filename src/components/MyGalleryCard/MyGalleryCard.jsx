...
const MyGalleryCard = ({artwork, onRemove}) => {
    ...
    const handleDeleteFromGallery=()=>{
        ...
        if (result.isConfirmed) {
            ...
            fetch(`http://localhost:3000/mygallery/delete/${artwork._id}`,{
            method:"DELETE"
            })
            .then((res)=>res.json())
            .then((data)=>{
    ...
    const handleUpdate=(e)=>{
        ...
        fetch(`http://localhost:3000/myArtworks/update/${artwork._id}`,{
            method:"PATCH",
            headers:{
                ...
                <div className="card bg-base-100 w-full h-full shadow-sm">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button onClick={handleDeleteFromGallery} className="my-btn my-btn:hover btn btn-primary mx-auto">Delete</button>
                            <button onClick={handleModal} className="my-btn my-btn:hover btn btn-primary mx-auto">Update</button>
                            ...
                            <div className="modal-box">
                                ...
                                <form method="dialog">
                                    <button className="btn my-btn my-btn:hover text-white">Cancel</button>
                                </form>
                                </div>
                            </div>
                            </dialog>
